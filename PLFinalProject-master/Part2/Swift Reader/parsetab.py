...
_lr_productions = [
  ...
  ('list -> LPAREN items RPAREN','list',3,'p_list','yacc.py',236),
  ('items -> item items','items',2,'p_items','yacc.py',240),
  ('items -> empty','items',1,'p_items_empty','yacc.py',244),
  ('empty -> <empty>','empty',0,'p_empty','yacc.py',248),
  ('item -> atom','item',1,'p_item_atom','yacc.py',252),
  ('item -> quoted_list','item',1,'p_item_list','yacc.py',260),
  ('item -> call','item',1,'p_item_call','yacc.py',264),
  ('item -> empty','item',1,'p_item_empty','yacc.py',268),
  ('call -> LPAREN SIMB items RPAREN','call',4,'p_call','yacc.py',272),
  ('atom -> SIMB','atom',1,'p_atom_simbol','yacc.py',278),
  ('atom -> bool','atom',1,'p_atom_bool','yacc.py',282),
  ('atom -> NUM','atom',1,'p_atom_num','yacc.py',286),
  ('atom -> TEXT','atom',1,'p_atom_word','yacc.py',290),
  ('atom -> <empty>','atom',0,'p_atom_empty','yacc.py',294),
  ('bool -> TRUE','bool',1,'p_true','yacc.py',298),
  ('bool -> FALSE','bool',1,'p_false','yacc.py',302),
  ('atom -> NIL','atom',1,'p_nil','yacc.py',306),
]
